...
import org.pentaho.kettle.plugin.xsdgen.DialogClassUtil;
...
@Step(
        id = "xsdgen",
        image = "org/pentaho/kettle/plugin/xsdgen/steps/xsd.svg",
        i18nPackageName = "org.pentaho.kettle.plugin.xsdgen.steps",
        name = "xsdgen.Name",
        description = "xsdgen.TooltipDesc",
        categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Transform"
)

public class XsdGenStepMeta extends BaseStepMeta implements StepMetaInterface{
     ...
     */
    private static Class<?> PKG = XsdGenStepMeta.class; // for i18n purposes
     ...
     */
    public XsdGenStepMeta() throws Throwable {
        super();
    }
    ...
    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp) {
        return new XsdGenStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
    }
    ...
    public void loadXML(Node stepnode, List<DatabaseMeta> databases, IMetaStore metaStore) throws KettleXMLException {
        ...
        try {
            ...
            throw new KettleXMLException("XsdGen plugin unable to read step info from XML node", e);
        }
